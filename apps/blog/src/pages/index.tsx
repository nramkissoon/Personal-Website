...
function Blog(props: StaticProps) {
  ...
  return (
    <main className="relative mx-auto h-fit">
      <div className=" pointer-events-none absolute inset-0 bg-gradient-to-r from-violet-500 via-rose-500 to-emerald-500 overflow-hidden" />
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-radial from-transparent to-[#111] overflow-hidden" />
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-[#111]/20 via-[#18181800] to-[#111]/20 overflow-hidden"></div>
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-r to-[#18181866] via-[#111]/95 from-[#18181866] overflow-hidden"></div>

      <div className="relative z-2 max-w-4xl pt-12 mx-auto p-7 flex-col flex">
        ...
        <h2 className="mb-2 text-xl text-gray-400 font-medium">
