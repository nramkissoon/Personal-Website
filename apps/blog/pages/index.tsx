  ...
  return (
    <div className="container mb-9 group">
      <Link href={"/posts/" + props.slug} passHref>
        <a>
          <h2 className="mb-0 text-3xl font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-violet-300">
          ...
          <div className="flex text-slate-100 group-hover:text-rose-500">
            Read More
        ...
        <div className="flex space-x-5">
          <Link passHref href="https://github.com/nramkissoon">
            <a target="_blank" rel="noreferrer">
              <svg
                viewBox="0 0 16 16"
                className="w-6 h-6 fill-slate-100 hover:cursor-pointer hover:fill-gray-400"
              >
