  ...
  return (
    <>
      ...
      <div className="container max-w-4xl pt-12 mx-auto p-7 selection:bg-teal-700 selection:text-slate-50">
        ...
        <h1 className="py-2 mt-3 mb-8 text-5xl font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-violet-200">
          {title}
        </h1>
        {children}
        <hr className="border-2 my-9 border-rose-600" />
