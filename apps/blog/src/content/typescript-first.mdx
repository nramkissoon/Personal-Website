...
seoDescription: >
  Beginners coming to web development and programming in general should skip JavaScript and learn TypeScript first.
description: >
  Newcomers coming to web development and programming in general should skip JavaScript and learn TypeScript first.
tags: ["TypeScript"]
---

If I search for "web development tutorial" in January 2022, one of the first results is a [front-end learning roadmap from W3 Schools](https://www.w3schools.com/whatis/).
